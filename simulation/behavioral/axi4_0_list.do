...
#
#  File     axi4_0_list.do (Thu Apr 03 16:17:14 2014)
#
...
# eval add list $binopt $tbpath${ps}axi4_0${ps}INTERCONNECT_ARESETN
  ...
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_ARESET_OUT_N
...
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_ACLK
...
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_AWUSER
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_AWVALID
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_AWREADY
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_WID
  ...
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_WLAST
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_WUSER
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_WVALID
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_WREADY
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_BID
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_BRESP
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_BUSER
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_BVALID
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_BREADY
...
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_ARUSER
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_ARVALID
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_ARREADY
...
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_RLAST
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_RUSER
# eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_RVALID
  eval add list $hexopt $tbpath${ps}axi4_0${ps}M_AXI_RREADY
